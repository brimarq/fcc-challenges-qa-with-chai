...
// -----------------------------------------------------------------------------
  ...
  suite('Comparisons', function() {
    ...
    test('#approximately', function() {
      ...
      assert.approximately(weirdNumbers(0.5), 1, 0.5); // delta = (1 - 0.5)
      assert.approximately(weirdNumbers(0.2), 1, 0.8); // delta = (1 - 0.2)
    });
  });
...
// -----------------------------------------------------------------------------
  ...
  suite('Strings', function(){
    ...
    /** 14 - #include (or #notInclude ) works for strings too !! **/
